    ...
    Views.Profile = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            if ($('.user-available').length > 0) {
                $('.user-available').find('small').css({
                    "left" :  ($('.user-available').parents('.switch-for-hide').find('.switchery').width() - $('.user-available').parents('.switch-for-hide').find('small').width() + 5) + "px"
                })
